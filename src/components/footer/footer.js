			...
			<footer>
				<article className="mainFooter">
					<section className="footerInfo">
						<section className="footerAbout">
							...
							>
								<Img
									fluid={data.contentfulLogo.logo.fluid}
									alt="Asasline"
									title="Asasline"
								/>
							</figure>
							<p>{intl.formatMessage({ id: 'footerAboutText' })}</p>
                ...
                <li><FontAwesomeIcon icon={faGlobe} />  www.asasline.com</li> */}
							...
							<ul className="footerScoialNetwork">
								<li>
									<a
										...
										target="_blank"
										rel="noreferrer"
										title="Asasline facebook page"
										aria-label="Asasline facebook page"
									>
								...
								<li>
									<a
										...
										target="_blank"
										rel="noreferrer"
										title="Asasline instagram page"
										aria-label="Asasline instagram page"
									>
						...
						<section className="footerMainMenu">
							...
							<ul>
								...
								<li>
									{
										<Link to="/services">
											{intl.formatMessage({ id: 'services_page' })}
										</Link>
									}
								</li>
								<li>
								...
								<li className="lastElm">
									{
										<Link to="/quote">
											{intl.formatMessage({ id: 'devis_page' })}
										</Link>
									}
								</li>
							</ul>
						...
						<section className="footerNewsletter">
							...
							<p>
								{intl.formatMessage({ id: 'newslaetterText.callToAction' })}
							</p>
							<Form
								method="POST"
								data-netlify="true"
