    ...
    <>
      ...
      <Navbar sticky="top" variant="dark" expand="lg" className="Navbar" >
        <Navbar.Brand as="div" href="#home" onContextMenu={(e) => e.preventDefault()} >
          <AniLink cover direction="down" duration={1} to={intl.locale === "en" ? '/' : '/fr'} bg="#f7af3d">
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="m-auto" >
            ...
            <Nav.Link as={Link} to="/about"><FormattedMessage id="about_page" /></Nav.Link>
            <Nav.Link as={Link} to="/services"><FormattedMessage id="services_page" /></Nav.Link>
